...
<div class="page-feedback">
	<div class="container">
		<div class="page-feedback-toggle">
			<a class="collapsed" data-toggle="collapse" data-target="#page-feedback-form">Did you find this content helpful?</a>
		</div>
		<div class="page-feedback-meta">
			Last updated: <time class="content-modified" datetime="2015-12-5T23:59:59">5 December 2015</time> by <span class="content-modified-by">Corporate Communications</span>
		</div>
		<div id="page-feedback-form" class="collapse page-feedback-form">
			<form class="form">
					<textarea class="form-control" placeholder="give us some feedback!!!">
