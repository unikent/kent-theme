module.exports = function(grunt) {
	grunt.initConfig({
		...
		sass: {
			...
			hologram: {
				...
				files: {
					'docs/hologram.css': 'plugins/hologram/doc_assets/hologram.scss'
				}
			}
		},
	...
	// Define tasks
	grunt.registerTask('development', [ 'jshint', 'concat', 'uglify', 'copy', 'sass:dist', 'postcss', 'cssnano', 'modernizr']);
