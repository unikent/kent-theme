...
<html lang="en-GB" class="no-js">
	<head>
		...
		<link rel="apple-touch-icon" sizes="57x57" href="<?php KentThemeHelper::getThemeWebRoot();?>assets/images/favicons/apple-touch-icon-57x57.png">
		<link rel="apple-touch-icon" sizes="60x60" href="<?php KentThemeHelper::getThemeWebRoot();?>assets/images/favicons/apple-touch-icon-60x60.png">
		<link rel="apple-touch-icon" sizes="72x72" href="<?php KentThemeHelper::getThemeWebRoot();?>assets/images/favicons/apple-touch-icon-72x72.png">
		<link rel="apple-touch-icon" sizes="76x76" href="<?php KentThemeHelper::getThemeWebRoot();?>assets/images/favicons/apple-touch-icon-76x76.png">
		<link rel="apple-touch-icon" sizes="114x114" href="<?php KentThemeHelper::getThemeWebRoot();?>assets/images/favicons/apple-touch-icon-114x114.png">
		<link rel="apple-touch-icon" sizes="120x120" href="<?php KentThemeHelper::getThemeWebRoot();?>assets/images/favicons/apple-touch-icon-120x120.png">
		<link rel="apple-touch-icon" sizes="144x144" href="<?php KentThemeHelper::getThemeWebRoot();?>assets/images/favicons/apple-touch-icon-144x144.png">
		<link rel="apple-touch-icon" sizes="152x152" href="<?php KentThemeHelper::getThemeWebRoot();?>assets/images/favicons/apple-touch-icon-152x152.png">
		<link rel="apple-touch-icon" sizes="180x180" href="<?php KentThemeHelper::getThemeWebRoot();?>assets/images/favicons/apple-touch-icon-180x180.png">
		<link rel="icon" type="image/png" href="<?php KentThemeHelper::getThemeWebRoot();?>assets/images/favicons/favicon-32x32.png" sizes="32x32">
		<link rel="icon" type="image/png" href="<?php KentThemeHelper::getThemeWebRoot();?>assets/images/favicons/favicon-194x194.png" sizes="194x194">
		<link rel="icon" type="image/png" href="<?php KentThemeHelper::getThemeWebRoot();?>assets/images/favicons/favicon-96x96.png" sizes="96x96">
		<link rel="icon" type="image/png" href="<?php KentThemeHelper::getThemeWebRoot();?>assets/images/favicons/android-chrome-192x192.png" sizes="192x192">
		<link rel="icon" type="image/png" href="<?php KentThemeHelper::getThemeWebRoot();?>assets/images/favicons/favicon-16x16.png" sizes="16x16">
		<link rel="manifest" href="<?php KentThemeHelper::getThemeWebRoot();?>assets/images/favicons/manifest.json">
		<link rel="mask-icon" href="<?php KentThemeHelper::getThemeWebRoot();?>assets/images/favicons/safari-pinned-tab.svg" color="#003882">
		<link rel="shortcut icon" href="<?php KentThemeHelper::getThemeWebRoot();?>assets/images/favicons/favicon.ico">
		<meta name="msapplication-TileColor" content="#ffffff">
		<meta name="msapplication-TileImage" content="<?php KentThemeHelper::getThemeWebRoot();?>assets/images/favicons/mstile-144x144.png">
		<meta name="msapplication-config" content="<?php KentThemeHelper::getThemeWebRoot();?>assets/images/favicons/browserconfig.xml">
	...
	<body class="<?php echo !empty($home_page) ? ' global-header global-header-transparent"' :'global-header global-header-standard' ; ?><?php echo ($slim)?' slim-header':''; ?>">
		<?php if(!$home_page){ ?>
